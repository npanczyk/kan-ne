...
def symbolic_FI(equation_file, X_test, Y_test, input_names, output_names, save_as, shap_range=300, width=0.2):
...
def fnn_FI(model, X_test, Y_test, input_names, output_names, save_as, shap_range=300, width=0.2 ):
...
if __name__=="__main__":
    ...
    for model, info in datasets_dict.items():
        ...
        symbolic_FI(equation_file, X_test, Y_test, input_names, output_names, save_as, shap_range=10, width=0.2)
