...
def kan_shap(equation_file, X_test, input_names, output_names, save_as, shap_range=300, width=0.2):
...
if __name__=="__main__":
    ...
    for model, info in datasets_dict.items():
        ...
        symbolic_FI(equation_file, X_test, input_names, output_names, save_as, shap_range=300, width=0.2)
